...
public class Program : IMod
{
    ...
    public void Start(IModLoaderV1 loader)
    {
        ...
        var modDirectory = _modLoader.GetDirectoryForModId(MyModId);
        var configDirectory = _modLoader.GetModConfigDirectory(MyModId);

        _input = new Input(modDirectory, configDirectory);
    ...
    private void SetInputs(ref IPlayerInput inputs, int port) => _input.SetInputs(ref inputs, port);
